...
public class Calender1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//handle date
		Select selmn =new Select(driver.findElement(By.xpath("//body/div[@id='ui-datepicker-div']/div[1]/div[1]/select[1]")) );
		selmn.selectByVisibleText("Aug");
		Select selyr =new Select(driver.findElement(By.xpath("//body/div[@id='ui-datepicker-div']/div[1]/div[1]/select[2]")) );
		selyr.selectByVisibleText("2030");
